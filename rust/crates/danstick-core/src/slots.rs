...
pub const ENV_MODE: &str = "DANSTICK_SLOTS";
pub const ENV_COUNT: &str = "DANSTICK_SLOT_COUNT";
pub const ENV_ON_LEAVE: &str = "DANSTICK_ON_LEAVE";
pub const ENV_LAYOUT: &str = "DANSTICK_LAYOUT";
