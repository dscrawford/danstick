...
use danstick_core::layout::Layout;
use danstick_core::sdl::AxisSpan;
use danstick_core::{layout, scope};
...
use danstick_core::capture::FINISH_HOLD_SECONDS;
...
mod describing_presses {
    ...
    use danstick_core::binding::BindingKind;
    use danstick_core::capture::{Event, MappingRun};
    use danstick_core::layout;
    use danstick_core::sdl::AxisSpan;
...
mod binding_one_control {
    ...
    use danstick_core::capture::{Event, MappingRun, Outcome};
    use danstick_core::control::Control;
    use danstick_core::layout;
    use danstick_core::sdl::AxisSpan;
