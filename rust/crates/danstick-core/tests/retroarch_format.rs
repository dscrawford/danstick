//! What danstick writes into a RetroArch autoconfig, and what it refuses to.
...
use danstick_core::retroarch::{drop_shadowed_axis_halves, lines, ANALOG_STEMS};
...
fn a_line_with_no_separator_is_not_mistaken_for_a_key_and_is_preserved() {
    ...
    assert_eq!(
        out,
        ["# danstick Player 1", "input_r_y_minus_btn = \"11\"", ""]
    );
}
